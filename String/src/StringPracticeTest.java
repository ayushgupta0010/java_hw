...
class StringPracticeTest extends StringPractice {
  ...
  void testNumPunctAfterNonPunct() {
    assertEquals(StringPractice.numPunctAfterNonPunct("!aaab"), 1);
    assertEquals(StringPractice.numPunctAfterNonPunct("!aaa.b"), 2);
    assertEquals(StringPractice.numPunctAfterNonPunct("!a;aa.b"), 3);
    assertEquals(StringPractice.numPunctAfterNonPunct("!a.a,a'b"), 4);
    assertEquals(StringPractice.numPunctAfterNonPunct("!a##aa.b"), 2);
  }
}
